...
public class Under10 extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private String category = "10mins";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_under10);

        DataItemAdapter adapter = new DataItemAdapter(this, dataItemList);
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rvItems10);
        ...
        myRecycler = (RecyclerView) findViewById(R.id.rvItems10);
